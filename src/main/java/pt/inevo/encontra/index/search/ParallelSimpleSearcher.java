...
//                Result<Descriptor> result = new Result<Descriptor>(descr);
//                result.setScore(descr.getDistance(d)); // TODO - This is distance not similarity!!!
...
//    }
//
//    protected ResultSetDefaultImp<IEntry> performEqualQuery(Descriptor d, boolean equal) {
//
//        ResultSetDefaultImp resultSet = new ResultSetDefaultImp<Descriptor>();
//        if (!equal) {
